...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      console.log("Navigating to /admin"); // Add this
      navigate("/admin");
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-600 via-primary-700 to-primary-900 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md flex flex-col items-center justify-center">
        <div className="flex flex-col items-center justify-center text-center mb-8">
          <img
            src="/MassHealthLogo2.svg"
            alt="MassHealth"
            className="w-60 h-60 lg:w-40 lg:h-40 mb-10 animate-fade-in"
          />
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 w-full">
          ...
          <div className="mt-6 flex items-center justify-center">
            <a
              href="/"
              className="text-sm text-gray-500 hover:text-primary-600 transition text-center"
            >
              Back to main site
            </a>
          </div>
